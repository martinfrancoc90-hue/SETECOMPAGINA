<section id="servicios">
    <div class="container">
        <h2 class="title">Soluciones Tecnológicas</h2>
        <div class="line-services mb-4">
        ...
        <div class="row mt-4">
            <div class="col-lg-6 mb-3">
                <article class="card">
                    <div class="card-body">
                        <h3 class="card-title">01. Seguridad Electrónica</h3>
                        <div class="content">
            ...
            <div class="col-lg-6 mb-3">
                <article class="card">
                    <div class="card-body">
                        <h3 class="card-title">04. Otros</h3>
                        <div class="content">
                            <div class="each-services d-flex" data-bs-toggle="modal" data-bs-target="#serv-bms">
                                <div class="icon-service"><i class="fas fa-angle-double-right"></i></div>
                                <div class="name-service">Sistema de Administración de Edificios (BMS)</div>
                                @include('services_setecom/popup_sist_adm_edif')
                            </div>
                            <div class="each-services d-flex" data-bs-toggle="modal" data-bs-target="#serv-mant">
                                <div class="icon-service"><i class="fas fa-angle-double-right"></i></div>
                                <div class="name-service">Mantenimiento Preventivo y Correctivo</div>
                                @include('services_setecom/popup_mantenimientos')
                            </div>
                            <div class="each-services d-flex" data-bs-toggle="modal" data-bs-target="#serv-fids">
                                <div class="icon-service"><i class="fas fa-angle-double-right"></i></div>
                                <div class="name-service">Sistema de Información de Vuelos (FIDS)</div>
                                @include('services_setecom/popup_sist_info_vuelos')
                            </div>
                        </div>
                    </div>
                </article>
